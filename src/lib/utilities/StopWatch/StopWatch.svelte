...
<svg viewBox="-50 -50 100 100" on:click={onClick} on:keyup={onKeyDown}>
	<circle class="{hourStrokeColors[$settings.color]} {hourFillColors[$settings.color]} stroke-2" r="40" />
	...
	<g transform="rotate({30 * hours})">
		<line class="stroke-2 stroke-clock-hour-50" y1="-33" y2="-40" />
		<line class="stroke-6 stroke-clock-hour-50 fill-black" y1="-45" y2="-50" />
		<circle class="stroke-2 stroke-clock-hour-50 fill-black" r="4" cx="0" cy="-29" style="fill-opacity: .25;" />
	</g>

	<!-- minute hand -->
	<g transform="rotate({6 * minutes})">
		<line class="stroke-{ColorNames[$settings.color]}-600 fill-{ColorNames[$settings.color]}-100/10 stroke-0.5" y1="0" y2="-20" />
		<circle
		...
		<line class="stroke-{ColorNames[$settings.color]}-600 fill-{ColorNames[$settings.color]}-100/10 stroke-2" y1="-15" y2="-17" />
		<circle
			class="stroke-{ColorNames[$settings.color]}-600 fill-{ColorNames[$settings.color]}-100/10 stroke-0.5"
	...
	<g transform="rotate({6 * seconds})">
		<line class="{secondStrokeColors[$settings.color]} {secondFillColors[$settings.color]} stroke-2" y1="-34" y2="-45" />
		<line class="{secondStrokeColors[$settings.color]} stroke-1" y1="-24" y2="-19.5" />
		<circle class="{secondStrokeColors[$settings.color]} {secondFillColors[$settings.color]} 5 stroke-1" r="5" cx="0" cy="-29" style="fill-opacity: .25;" />
	</g>
</svg>
